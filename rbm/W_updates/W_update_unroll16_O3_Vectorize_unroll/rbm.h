...
void W_update(double * W, double * h0_cap, double * h1_cap,
    ...
    // TODO
    // for (int i = 0; i < D; i++){
    //     img_tmp_mem0[i] = double(x0);
    //     img_tmp_mem1[i] = double(x1);
    // }
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        for (int j = 0; j < D; j+=16)
        {
            ...
            __m256d x01d = { (double)x0[j], 
                    (double)x0[j+1], 
                    (double)x0[j+2], 
                    (double)x0[j+3]
                    };

            __m256d x11d = { (double)x1[j], 
                    (double)x1[j+1], 
                    (double)x1[j+2], 
                    (double)x1[j+3]
                    };

            __m256d x02d = { (double)x0[j + 4], 
                    (double)x0[j+5], 
                    (double)x0[j+6], 
                    (double)x0[j+7]
                    };

            __m256d x12d = { (double)x1[j + 4], 
                    (double)x1[j+5], 
                    (double)x1[j+6], 
                    (double)x1[j+7]
                    };

            __m256d x03d = { (double)x0[j + 8], 
                    (double)x0[j+9], 
                    (double)x0[j+10], 
                    (double)x0[j+11]
                    };

            __m256d x13d = { (double)x1[j + 8], 
                    (double)x1[j+9], 
                    (double)x1[j+10], 
                    (double)x1[j+11]
                    };

            __m256d x04d = { (double)x0[j+12], 
                    (double)x0[j+13], 
                    (double)x0[j+14], 
                    (double)x0[j+15]
                    };

            __m256d x14d = { (double)x1[j + 12], 
                    (double)x1[j+13], 
                    (double)x1[j+14], 
                    (double)x1[j+15]
                    };
