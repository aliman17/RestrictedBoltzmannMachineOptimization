...
p1 <- plot_perf("perf_cod_train_update", 10308, 7117)
p2 <- plot_perf("perf_b_update", 0, 2358)
p3 <- plot_perf("perf_c_update", 3, 0)
p4 <- plot_perf("perf_d_update", 0, 20)
p5 <- plot_perf("perf_w_update", 3930, 0)
p6 <- plot_perf("perf_u_update", 40, 0)
p7 <- plot_perf("perf_h0_update", 1582, 0)
p8 <- plot_perf("perf_h1_update", 1582, 0)
...
COD_training_update:
	...
	All flops: 10308 n + 7117

COD_train:
	All: 2500*(10308 n + 7117)
