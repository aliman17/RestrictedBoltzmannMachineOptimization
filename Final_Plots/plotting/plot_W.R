...
get_base_plot <- function(name, y_lim){
  ...
  annotate("text", label = "scalar peak performance", x = 1600, y = 4.15, size = 5, colour = "#dd0000") + theme(text = element_text(size=20))
  return(p)
}
...
DIRS = c( "./baseline/",
          ...
          "./vector/W_update_unroll16_O3_fma_Vectorize_double/")
